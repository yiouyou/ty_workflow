...
import requests
import subprocess
import _log_ci_i2i_202303 as _log
...
def parse_ctrl_net(_str):
    ...
    _net = {
        ...
        # "binary": ["binary", "control_scribble-fp16 [c508311e]"],
...
def parse_ctrl_units(_ctrls, user_sys_conf, call_ctrlNet_api):
    _re = []
    for i in _ctrls.keys():
        ...
        if i_module == "fake_scribble" and user_sys_conf == "猜想":
            _i["guessmode"] = True
        _re.append(_i)
    return _re
